...
const initialRows = [
  ...
  createData(6, 'Tarefa 6', 'Descrição da Tarefa 6', '2022-01-08', '2022-05-08', 'Aguardando', 'Recurso 6'),
  createData(7, 'Tarefa 7', 'Descrição da Tarefa 7', '2022-15-08', '2022-19-08', 'Em Andamento', 'Recurso 7'),
  createData(8, 'Tarefa 8', 'Descrição da Tarefa 8', '2022-03-09', '2022-10-09', 'Cloncluída', 'Recurso 8'),
];
